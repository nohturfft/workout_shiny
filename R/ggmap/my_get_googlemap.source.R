# https://github.com/dkahle/ggmap/blob/master/R/get_googlemap.R
# 
#' Get a Google Map.
#'
...
wd <- "~/Dropbox/Correspondence/Private/Health_and_Exercise/Runkeeper/workout_shiny/R"
setwd(wd)
source("my_file_drawer.source.R")
source("my_helpers.source.R")
source("my_register_google.R")
library(png)
source("my_XY2LatLon.source.R")
source("my_LatLon2XY.source.R")
goo <- get_googlemap()
